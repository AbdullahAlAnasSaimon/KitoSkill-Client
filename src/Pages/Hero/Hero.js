...
const Hero = () => {
  return (
    <div className='flex justify-around items-center hero-bg'>
      <div className='w-5/12'>
        <h1 className='text-5xl font-bold text-gray-800 my-6'>Unlock the power of learning that gets you.</h1>
